...
export function MFTrailBannerCard() {
  return (
    <section className="rounded-xl overflow-hidden bg-[#1e1b4b] text-white relative flex flex-col">
      ...
      <div className="relative z-10 p-4 sm:p-5 flex flex-col gap-5">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-bold uppercase tracking-[0.12em] text-amber-400">
        ...
        <div className="flex flex-col gap-1">
          <div className="text-xs font-medium text-indigo-300 uppercase tracking-widest">
            Trail earned per ₹1 Cr AUM
          </div>
          <div className="flex items-end gap-2 mt-1">
            <span className="text-4xl sm:text-5xl font-black leading-none tracking-tight text-amber-400">
              ₹8,000
            </span>
            <span className="text-sm text-white/60 font-semibold mb-1.5">/ year</span>
          </div>
        ...
        <button
          type="button"
          className="group w-full inline-flex items-center justify-between gap-2 rounded-lg bg-amber-400 text-[#1e1b4b] text-sm font-extrabold py-3 px-4 hover:bg-amber-300 active:scale-[0.98] transition-all"
        >
